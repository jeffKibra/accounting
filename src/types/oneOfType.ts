...
type OneOnly<Obj, Key extends keyof Obj> = {
  /**
   * loop over all the keys of the object type except the one we passed as the 2nd
...
/**
 * loop over the keys of the object type to generate all the OneOnly types for every key
 */
