              ...
              <>
                <GridItem colSpan={[6, null, 2]}>
                  <FormControl
                    isDisabled={loading}
                    isRequired
                    isInvalid={itemErrors?.startDate}
                  >
                    <CustomLabel htmlFor={`selectedItems.${index}.startDate`}>
                      Start Date
                    </CustomLabel>
                    <Controller
                      name={`selectedItems.${index}.startDate`}
                      control={control}
                      rules={{
                        required: { value: true, message: '* Required!' },
                      }}
                      render={({ field: { name, onBlur, ref, value } }) => {
                        return (
                          <ControlledDatePicker
                            ...
                            onChange={value =>
                              updateItemFields('startDate', value, index)
                            }
                          />
                        );
                      }}
